...
<!-- 현재 주석 아래쪽으로 작업해주세요-------------------------------------------------------------------------------------------------------- -->
	...
	<div class="col-lg-8 col-md-8 mx-auto">
		<form action="petInsertPro.do" name="frm" method="post" enctype="multipart/form-data" onsubmit="return chk()">

			<table class="table table-striped" style="text-align: center;">
				<thead>
					<tr>
						<th colspan="2" style="font-size: 25px; padding: 20px;">반려동물 프로필 등록</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td width="40%">사진</td>
						<td><input class="form-control" type="file" name="pet_photo" required="required"
						onchange="readURL(this);" accept="image/png, image/jpeg, image/jpg"></td>
					</tr>
					<tr>
						<td>사진 프리뷰</td>
						<td><img  id="preview" width="80%" style="width: 400px; height: 400px" /></td>
					</tr>
					<tr>
						<td>이름</td>
						<td>
					...
					<tr>
						...
						<td>
							...
							required="required" placeholder="숫자로 입력해주세요 ex)1,2,3...">
						</td>
					</tr>
					<tr>
						<td>몸무게</td>
			...
			<div style="display: inline-block; float: right;">
				<button type="submit" class="btn btn-outline-secondary" style="margin-bottom: 10px;">등록</button>
			</div>
