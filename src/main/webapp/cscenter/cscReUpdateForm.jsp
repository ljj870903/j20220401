...
<!-- 현재 주석 아래쪽으로 작업해주세요-------------------------------------------------------------------------------------------------------- -->
			...
			<div class="col-lg-7 col-md-8 mx-auto">
				<form action="cscReUpdatePro.do?pageNum=${pageNum }&cs_num=${cs_num}" method="post">
					<table class="table table-striped" style="text-align: center;">
						<thead>
							<tr>
								<th colspan="2" style="font-size: 25px; padding: 20px;">1:1문의 답변 수정하기</th>
							</tr>
						</thead>
						<tbody>
							<tr>
					...
					<div style="display: inline-block; float: right;">
						<button type="submit" class="btn btn-outline-secondary" style="margin-bottom: 10px;">답변 수정하기</button>
					</div>
				</form>
				</div>			
